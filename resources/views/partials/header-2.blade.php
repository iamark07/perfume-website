<header id="header"
    class="header sticky !bg-gray-900 top-0 left-0 w-full z-50 py-5 px-5 md:px-10 flex justify-between items-center transition-all duration-300 bg-gray-900/30 backdrop-blur-lg">
    <!-- Logo -->
    ...
    <!-- Search Box -->
    <div id="search-box"
        class="fixed w-72 md:w-96 z-20 top-10 left-1/2 transform -translate-x-1/2 bg-white p-2 rounded-lg shadow-lg opacity-0 pointer-events-none transition-all duration-300">
        <div>
    ...
    <div id="mobile-menu"
        ...
        <nav class="text-white text-lg py-6 px-5">
            ...
            <ul class="mt-7 flex flex-col gap-5 poppins-regular overflow-auto">
                ...
                <li><a href="{{ url('/admin/dashboard') }}"><i class="ri-user-settings-line text-xl me-2"></i>Admin Panel</a>
                </li>
                <li><a href="{{ url('/settings') }}"><i class="ri-settings-5-line text-xl me-2"></i>Settings</a></li>
                <li><a href="#"><i class="ri-logout-circle-r-line text-xl me-2"></i>Log out</a>
