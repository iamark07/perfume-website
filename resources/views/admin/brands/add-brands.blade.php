    ...
    <main class="">
        ...
        <div class="lg:flex">
            ...
            <div class="lg:w-[86%] xl:w-[88%] w-full flex flex-col items-center py-10 px-5 md:px-10">
                <h1 class="text-3xl font-semibold mb-6">Add New Brand</h1>

                <!-- Brand Form -->
                <form id="addBrandForm" action="" method="POST"
                    ...
                    <button type="submit" class="bg-gray-900 text-white py-2 px-6 rounded-md mt-4">Add Brand</button>
                </form>
            </div>
        </div>
    </main>
