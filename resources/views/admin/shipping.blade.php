            ...
            <div class="lg:w-[86%] xl:w-[88%] w-full flex flex-col">
                <div class="px-5 pb-10 mt-10">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-5">
                        <h3 class="text-xl md:text-2xl font-semibold text-gray-800">Shipping</h3>
                    ...
                    <div class="flex flex-col gap-5 mt-5">
                        ...
                        <div class="bg-white p-5 shadow-[0px_0px_20px_5px_rgba(229,231,235,0.9)] rounded-md">
                            {{-- <div class="flex justify-between">
                                <h2 class="text-2xl font-semibold mb-4">Manage Shipping</h2>
                            </div> --}}
                                ...
                                <table class="min-w-full table-auto text-sm border-collapse">
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600">
                                            ...
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Shipping Address</th>
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Shipping Status</th>
                                    ...
                                    <tbody class="text-gray-800">
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">123 Street, City</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-green-600 font-semibold text-nowrap">Shipped</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">
                                                <a href="{{ url('/admin/shipping/edit') }}" class="text-blue-600 hover:text-blue-800">Edit</a>
                                                |
                                                <a href="{{ url('/admin/shipping/delete') }}" class="text-red-600 hover:text-red-800">Delete</a>
                                            </td>
                                        </tr>
