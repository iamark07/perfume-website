            ...
            <div class="lg:w-[86%] xl:w-[88%] w-full flex flex-col">
                <div class="px-5 pb-10 mt-10">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-5">
                        <h3 class="text-xl md:text-2xl font-semibold text-gray-800">Order History</h3>
                                ...
                                <table class="min-w-full table-auto text-sm border-collapse">
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600">
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Order ID</th>
                                            ...
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Order Date</th>
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Total Amount</th>
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Status</th>
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-gray-800">
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">ORD001</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">Rahul Singh</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">rahul.singh@gmail.com</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">2025-01-20</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">₹2500</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-green-600 font-semibold text-nowrap">Delivered</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">
                                                <a href="{{ url('/admin/order-history/delete') }}" class="text-red-600 hover:text-red-800">Delete</a>
                                            </td>
                                        </tr>
