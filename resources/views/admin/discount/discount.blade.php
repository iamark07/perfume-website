            ...
            <div class="lg:w-[86%] xl:w-[88%] w-full flex flex-col">
                <div class="px-5 pb-10 mt-10">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-5">
                        <h3 class="text-xl md:text-2xl font-semibold text-gray-800">Discounts</h3>
                    ...
                    <div class="flex flex-col gap-5 mt-5">
                        ...
                        <div class="bg-white p-5 shadow-[0px_0px_20px_5px_rgba(229,231,235,0.9)] rounded-md">
                            <div class="flex justify-end items-center">
                                {{-- <h2 class="text-2xl font-semibold">Manage Discounts</h2> --}}
                                <!-- Add Discount Button -->
                                <a href="{{ url('/admin/discount/add-discount') }}" class="bg-gray-900 text-white text-sm md:text-md py-2 px-5 rounded-md">Add Discount</a>
                            </div>

                            <!-- Table Container with Horizontal Drag -->
                            <div id="scrollableTable" class="table_overflow overflow-x-auto cursor-grab w-full mt-6">
                                <table class="min-w-full table-auto text-sm border-collapse">
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600">
                                            ...
                                            <th class="px-4 py-2 text-center border border-gray-300 text-nowrap">Coupon Code</th>
                                    ...
                                    <tbody class="text-gray-800">
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">SAVE20</td>
                                            ...
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">
                                                <a href="{{ url('admin/discount/edit-discount') }}" class="text-blue-600 hover:text-blue-800">Edit</a>
                                                |
                                                <a href="{{ url('admin/discount/delete-discount') }}" class="text-red-600 hover:text-red-800">Delete</a>
                                            </td>
                                        </tr>
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">002</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">FREESHIP</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">Free Shipping</td>
                                            <td class="px-4 py-2 border border-gray-300 text-center text-nowrap">
                                                <a href="{{ url('admin/discount/edit-discount') }}" class="text-blue-600 hover:text-blue-800">Edit</a>
                                                |
                                                <a href="{{ url('admin/discount/delete-discount') }}" class="text-red-600 hover:text-red-800">Delete</a>
