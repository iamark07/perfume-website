    ...
    <main class="">
        ...
        <div class="lg:flex">
            ...
            <div class="lg:w-[86%] xl:w-[88%] w-full flex flex-col items-center py-10 px-5 md:px-10">
                <h1 class="text-3xl font-semibold mb-6">Edit Discount Coupon</h1>
                ...
                <form id="editDiscountForm" action="" method="POST"
                    ...
                    <button type="submit" class="bg-gray-900 text-white py-2 px-6 rounded-md col-span-2 mt-4">Update Coupon</button>
                </form>
            </div>
        </div>
    </main>
